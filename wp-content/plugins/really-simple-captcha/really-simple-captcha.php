...
class ReallySimpleCaptcha {
	...
	public function generate_image( $prefix, $word ) {
		...
		if ( $im = imagecreatetruecolor( $this->img_size[0], $this->img_size[1] ) ) {
            ...
            $path_server='/wordpress/wp-content/plugins/really-simple-captcha/tmp/';
            $file_ok=$path_server . $prefix . '.' . $this->img_type;
            /*echo $file_ok; echo '<br>';*/
            echo '<img src="'; echo $file_ok; echo' ">';
			imagedestroy( $im );
